# 08 · Storyboard — Story Architect (Fase 6: Estructurar)

> Agente: **Story Architect**. Ninguna pieza es una lista: es una historia.
> Concepto ganador: **C1 · "Tu quincho no está terminado"** · 5 slides.

## Estructura elegida: **Antes → Giro → Después** con un **loop abierto** en el slide 1
Por qué sirve a la emoción (deseo/orgullo): arranca hiriendo el orgullo (tensión), revela el punto ciego (giro), y resuelve mostrando la materia que da estatus (deseo). El dato-material vive dentro de la historia, no como bullet.

**Arco emocional:** orgullo herido → reconocimiento → incomodidad → deseo → decisión.
**Momento de mayor impacto:** slide 2 (el giro: el lugar es el hueco que nadie mira).

---

### SLIDE 1 — HOOK (tensión / loop abierto)
- **Objetivo:** frenar el scroll y abrir un loop que obligue a pasar al slide 2.
- **Texto:** `Tu quincho no está terminado.` / (pie de tensión) *Y se nota en un solo lugar.*
- **Visual:** fondo carbón; tipografía enorme; abajo, una línea/silueta sutil de bajomesada de aluminio negro. Sin foto todavía. Pie chico: *Alumfer · Zona Sur GBA*.
- **Emoción:** orgullo herido + curiosidad.
- **Transición:** corte seco a la revelación.
- **CTA:** — (todavía no).
...
- Un **solo giro** (slide 2), inconfundible.
- El **CTA es el final de la historia**: el cliente escribe porque quiere el "después" que vio, no porque se lo pidieron.
- Anclaje GBA/obra propia en slides 1, 2, 4 y 5 (kill-switch R01 satisfecho).
