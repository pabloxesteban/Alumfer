// Genera export/Alumfer_cartel_FICHA_TECNICA.pdf (A4 apaisado) a partir de ficha-tecnica.html
...
const out = fileURLToPath(new URL('../export/Alumfer_cartel_FICHA_TECNICA.pdf', import.meta.url));
