# Checklist de exportación — CP-20260701-instagram-policarbonato-quincho-v1
...
- [x] Valor real para la audiencia (3 datos técnicos traducidos a beneficio)
- [x] Legibilidad (contraste, jerarquía visual)

## Estructura
- [x] Jerarquía de bloques coherente (hook → 3× valor → CTA)
- [x] Compatibilidad con la plataforma destino (4:5, 5 slides ≤ 10)
